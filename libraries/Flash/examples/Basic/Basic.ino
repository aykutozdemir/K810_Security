...
void setup()
{
  ...
  font_table.print(Serial);
  Serial.println();

  // 4.b Determine the size of the array
  Serial.print("Rows: ");
  Serial.println(font_table.rows());
  Serial.print("Cols: ");
  Serial.println(font_table.cols());
  Serial.print("RAM: ");
  Serial.println(sizeof(font_table));

  // 4.c Access individual elements of the array using [] notation
  Serial.print("q: ");
  font_table['q'].print(Serial);
  Serial.println();
